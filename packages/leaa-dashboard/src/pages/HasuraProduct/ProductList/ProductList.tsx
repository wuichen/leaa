...
import { HASURA_GET_PRODUCTS, GET_PRODUCTS, DELETE_PRODUCT, UPDATE_PRODUCT } from '@leaa/dashboard/src/graphqls';
...
export default (props: IPage) => {
  ...
  const getProductsQuery = useQuery<{ products: ProductsWithPaginationObject }, ProductsArgs>(HASURA_GET_PRODUCTS, {
