...
import { GET_CATEGORIES, HASURA_GET_CATEGORIES } from '@leaa/dashboard/src/graphqls';
...
export const HasuraSelectCategoryIdByTree = forwardRef((props: IProps, ref: React.Ref<any>) => {
